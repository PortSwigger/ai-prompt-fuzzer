...
You can ignore this section, if you plan to download and use the [pre-compiled version](https://github.com/moha99sa/AI_Prompt_Fuzzer/tree/main/out/artifacts/AI_Prompt_Fuzzer_jar).
### Prerequisites
