...
You can ignore this section, if you plan to download and use the pre-compiled version (check [Releases section](https://github.com/moha99sa/AI_Prompt_Fuzzer/releases)).   
